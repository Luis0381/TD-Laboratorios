/*  TRANSMISION DE DATOS 2023 - Laboratorio N 4
...
// ENVIAMOS LA INFO Y VOLVEMOS A 0 LA VARIABLE "presionadas"
static void Keyboard_UpdateReport(void)
{
	...
	// HID_KEYBOARD_REPORT_SET_KEY_PRESS(g_keyBoard.report, ??? )
	//donde ??? es el valor para cada letra, revisamos en "hut1_21.pdf"
}
